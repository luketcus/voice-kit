...
template<typename... Ts> class OtaVoiceKitComponentFlashAction : public Action<Ts...> {
 public:
  OtaVoiceKitComponentFlashAction(OtaVoiceKitComponent *parent) : parent_(parent) {}
